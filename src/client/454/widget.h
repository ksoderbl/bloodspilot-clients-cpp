/* $Id: widget.h,v 1.3 2007/09/27 23:30:59 kps Exp $
 *
...
int Widget_create_float(int parent_desc, int x, int y, int width, int height, int border,
						DFLOAT *val, DFLOAT min, DFLOAT max, int (*callback)(int, void *, DFLOAT *),
						void *user_data);
