	...
	for (i = 0; i < NELEM(config_creator); i++) {
		if (full == true) {
			...
			config_widget_desc[num]
			    = Widget_create_form(NO_WIDGET, top, config_x, config_y, config_width,
						 config_height, 0);
			      ...
			      void *data)
{
	...
	Widget_create_label(widget_desc, config_space, *height
			    + (config_entry_height - config_text_height) / 2, label_width,
...
static int Config_create_showMessages(int widget_desc, int *height)
{
	return Config_create_bool(widget_desc, height, "showMessages",
				  ...
				  ? true : false, Config_update_instruments,
				  (void *) SHOW_MESSAGES);
}
...
static int Config_create_showRadar(int widget_desc, int *height)
{
	return Config_create_bool(widget_desc, height, "showRadar", BIT(instruments, SHOW_RADAR)
				  ? true : false, Config_update_instruments, (void *) SHOW_RADAR);
}
...
static int Config_create_showItems(int widget_desc, int *height)
{
	return Config_create_bool(widget_desc, height, "showItems", BIT(instruments, SHOW_ITEMS)
				  ? true : false, Config_update_instruments, (void *) SHOW_ITEMS);
}
...
static int Config_create_showDecor(int widget_desc, int *height)
{
	return Config_create_bool(widget_desc, height, "showDecor", BIT(instruments, SHOW_DECOR)
				  ? true : false, Config_update_instruments, (void *) SHOW_DECOR);
}
...
static int Config_create_clock(int widget_desc, int *height)
{
	return Config_create_bool(widget_desc, height, "clock", BIT(instruments, SHOW_CLOCK)
				  ? true : false, Config_update_instruments, (void *) SHOW_CLOCK);
}
...
static int Config_create_save(int widget_desc, int *height)
{
	...
	int space, button_desc, width = 2 * config_button_space + XTextWidth(buttonFont, save_str,
									     strlen(save_str));
