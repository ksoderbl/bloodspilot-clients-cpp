/* $Id: client.h,v 1.6 2007/09/27 23:30:58 kps Exp $
 *
...
#define SCORE_OBJECT_COUNT	25	/* was 100 */
typedef struct {
	DFLOAT score;
	int x, y, count, hud_msg_len, hud_msg_width, msg_width, msg_len;
...
int Handle_player(int id, int team, int mychar, char *player_name, char *real_name, char *host_name,
		  char *shape);
