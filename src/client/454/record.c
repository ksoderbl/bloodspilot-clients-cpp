/* $Id: record.c,v 1.5 2007/09/27 23:30:59 kps Exp $
 *
...
#ifdef _WINDOWS
extern void paintItemSymbol(unsigned char type, Drawable drawable, GC mygc, int x, int y,
			    int color);
#else
static void Dummy_paintItemSymbol(unsigned char type, Drawable drawable, GC mygc, int x, int y,
				  int color)
{
}
#endif
...
static int RDrawLine(Display * display, Drawable drawable, GC gc, int x1, int y1, int x2, int y2)
{
...
static void RPaintItemSymbol(unsigned char type, Drawable drawable, GC mygc, int x, int y,
			     int color)
{
#ifdef _WINDOWS
