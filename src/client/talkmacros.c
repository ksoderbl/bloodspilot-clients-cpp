...
static int Talk_macro_parse_mesg(char *outbuf, char *inbuf, long pos, long max)
{
	...
	int n_fields;
	char *tmpptr;
	char tmpptr1[MSG_PARSED_FIELD_LEN];
	char tmpptr2[MSG_PARSED_FIELD_LEN];
	char *tmpptr3 = 0;
	char *nextpos;
	char *filename;
	other_t *player = NULL;
			...
			case TALK_FAST_SPECIAL_TALK_CHAR:
				...
				case '=':	/* String comparison */
					...
					if (!strcmp(tmpptr1, tmpptr2)) {
						...
						pos =
						    Talk_macro_parse_mesg(outbuf, tmpptr3, pos,
									  max);
					}
					else if (n_fields == 4) {
						/* False */
				...
				case 'r':
					...
					if (n_fields <= 0 || nextpos == NULL)
						break;
					if ((tmpptr =
					     Talk_macro_get_field(inbuf,
								  (int) (randomMT() % n_fields +
									 1)))
					    == NULL) {
				...
				case 's':
					...
					break;
				case 't':
					if (self && BIT(Setup->mode, TEAM_PLAY))
...
xp_option_t talk_macro_options[] = {
	 ...
	 */
	XP_STRING_OPTION("msg1",
			 "#t: BALL!  Our BALL is gone! SAVE THE BALL! ***",
			 NULL, 0,
			 Set_talk_macro, NULL, Get_talk_macro,
			 XP_OPTFLAG_DEFAULT,
			 "Talkmessage 1.\n"),

	XP_STRING_OPTION("msg2",
	...
	XP_STRING_OPTION("msg3",
			 "#t: COVER!  Enemy ball is approaching our base. ---",
			 NULL, 0,
			 Set_talk_macro, NULL, Get_talk_macro,
			 XP_OPTFLAG_DEFAULT,
			 "Talkmessage 3.\n"),

	XP_STRING_OPTION("msg4",
			 "#t: POP!  Enemy ball is back at the enemy base. ---",
			 NULL, 0,
			 Set_talk_macro, NULL, Get_talk_macro,
			 XP_OPTFLAG_DEFAULT,
			 "Talkmessage 4.\n"),
	...
	XP_STRING_OPTION("msg6",
			 "#t: BALL!  #ln  took our BALL! SAVE IT!!! ***",
			 NULL, 0,
			 Set_talk_macro, NULL, Get_talk_macro,
			 XP_OPTFLAG_DEFAULT,
			 "Talkmessage 6.\n"),

	XP_STRING_OPTION("msg7",
			 "",
			 NULL, 0,
			 Set_talk_macro, NULL, Get_talk_macro,
			 XP_OPTFLAG_DEFAULT,
