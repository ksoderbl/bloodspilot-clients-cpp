...
typedef bool(*xp_color_index_option_setfunc_t) (xp_option_t * opt, int val);
...
#define XP_INT_OPTION_DUMMY \
	...
	/* integer color option stuff */

#define XP_COLOR_INDEX_OPTION_DUMMY \
	0, NULL, NULL

	int color_index_defval;
	int *color_index_ptr;
	xp_color_index_option_setfunc_t color_index_setfunc;
...
extern bool Set_option(const char *name, const char *value, xp_option_origin_t origin);
extern bool Set_noarg_option(xp_option_t * opt, bool value, xp_option_origin_t origin);
extern bool Set_bool_option(xp_option_t * opt, bool value, xp_option_origin_t origin);
extern bool Set_int_option(xp_option_t * opt, int value, xp_option_origin_t origin);
extern bool Set_color_index_option(xp_option_t * opt, int value, xp_option_origin_t origin);
extern bool Set_double_option(xp_option_t * opt, double value, xp_option_origin_t origin);
extern bool Set_string_option(xp_option_t * opt, const char *value, xp_option_origin_t origin);
extern bool Set_key_option(xp_option_t * opt, const char *value, xp_option_origin_t origin);

extern xp_option_t *Get_option_by_name(const char *name);
extern void Set_command(const char *command);
extern void Get_command(const char *command);

extern void Color_index_to_string(int val, char *buf, size_t size);
...
/* The 2 following should also have XP_ prefix. */
#define COLOR_INDEX_OPTION(name, defval, valptr, help) \
{ \
    xp_color_index_option,\
	name,\
	XP_OPTFLAG_CONFIG_COLORS, xp_option_origin_default,\
	help,\
	NULL,\
	XP_NOARG_OPTION_DUMMY,\
	XP_BOOL_OPTION_DUMMY,\
...
extern void Option_print_default_value(xp_option_t * opt);
